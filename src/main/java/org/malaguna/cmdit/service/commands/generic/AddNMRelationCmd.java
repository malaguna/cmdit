...
/**
 * It is a wrapper of AddNMRelationListCmd. It receives only one id to add,
 ...
 * @param <J>
 */
public abstract class AddNMRelationCmd<T extends AbstractObject<I>, I extends Serializable, S extends AbstractObject<J>, J extends Serializable> extends AddNMRelationListCmd<T, I, S,J> {
	private J e2Id = null;

	public AddNMRelationCmd(BeanFactory bf) {
		super(bf);
	}
