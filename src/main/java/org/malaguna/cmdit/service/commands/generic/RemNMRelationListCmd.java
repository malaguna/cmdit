...
public abstract class RemNMRelationListCmd<T extends AbstractObject<I>, I extends Serializable, S extends AbstractObject<J>, J extends Serializable> extends Command {
	...
	public RemNMRelationListCmd(BeanFactory bf) {
		super(bf);
		setReadOnly(false);
		setCanLog(true);
	}
	...
	public Command runCommand(){
		...
		for(J aux : e2Ids){
			...
			if(e2Obj != null){
				e1Obj = deleteAssociation(e1Obj, e2Obj);
